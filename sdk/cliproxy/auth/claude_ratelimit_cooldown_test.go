...
func TestAuthManager_CooldownPersistenceAcrossRestore(t *testing.T) {
	...
	newManager.SetCooldownStateStore(&mockCooldownStateStore{snapshots: cooldownRecordsToSnapshots(records)})
...
func (s *mockCooldownStateStore) Load(context.Context) ([]CooldownStateSnapshot, error) {
	return s.snapshots, nil
}

func (s *mockCooldownStateStore) Apply(context.Context, []CooldownStateSnapshot) error {
	return nil
}

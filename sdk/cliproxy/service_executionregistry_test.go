...
func (s *blockingServiceCooldownStore) Load(context.Context) ([]coreauth.CooldownStateSnapshot, error) {
	return nil, nil
}

func (s *blockingServiceCooldownStore) Apply(ctx context.Context, _ []coreauth.CooldownStateSnapshot) error {

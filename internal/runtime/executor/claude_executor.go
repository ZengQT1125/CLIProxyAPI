...
const claudeOAuthProfilePath = "/api/oauth/profile"
...
func (e *ClaudeExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	rawHTTPClient := helps.NewUtlsHTTPClient(ctx, e.cfg, auth, 0)
	httpClient := reporter.TrackHTTPClient(rawHTTPClient)
	...
	if httpResp.StatusCode < 200 || httpResp.StatusCode >= 300 {
		...
		err = e.claudeStatusErr(ctx, rawHTTPClient, apiKey, baseURL, httpResp.StatusCode, httpResp.Header, b)
		return resp, err
	}
...
func (e *ClaudeExecutor) CountTokens(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (cliproxyexecutor.Response, error) {
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		if decErr != nil {
			...
			return cliproxyexecutor.Response{}, e.claudeStatusErr(ctx, httpClient, apiKey, baseURL, resp.StatusCode, resp.Header, []byte(msg))
		}
		b, readErr := io.ReadAll(errBody)
		if readErr != nil {
			helps.RecordAPIResponseError(ctx, e.cfg, readErr)
		...
		return cliproxyexecutor.Response{}, e.claudeStatusErr(ctx, httpClient, apiKey, baseURL, resp.StatusCode, resp.Header, b)
	}

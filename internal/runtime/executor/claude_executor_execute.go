...
func (e *ClaudeExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	if httpResp.StatusCode < 200 || httpResp.StatusCode >= 300 {
		...
		if decErr != nil {
			...
			if fastRequest {
				return resp, wrapClaudeFastRequestError(true, httpResp.StatusCode, statusErr{code: httpResp.StatusCode, msg: msg})
			}
		...
		return resp, e.claudeStatusErr(ctx, rawHTTPClient, apiKey, baseURL, httpResp.StatusCode, httpResp.Header, b)
	}
